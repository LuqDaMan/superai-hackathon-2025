...
export class DocumentProcessingStack extends cdk.Stack {
  ...
  constructor(
    ...
    this.documentTrackingTable = new dynamodb.Table(
      this,
    ...
    masMonitorSchedule.addTarget(
      new targets.LambdaFunction(this.masMonitorFunction)
    );

    // Create Textract Processor Lambda function
    this.textractProcessorFunction = new lambda.Function(
      this,
      "TextractProcessorFunction",
      {
        ...
        environment: {
          PROCESSED_DOCS_BUCKET:
            coreInfrastructure.processedDocsJsonBucket.bucketName,
            ...
            TextractProcessorPolicy: new iam.PolicyDocument({
              statements: [
                ...
                new iam.PolicyStatement({
                  ...
                  resources: [
                    coreInfrastructure.processedDocsJsonBucket.arnForObjects(
                      "*"
                    ),
                  ],
                }),
    ...
    this.vectorizeContentFunction = new lambda.Function(
      this,
        ...
        policy: JSON.stringify([
          {
            ...
            Principal: [this.vectorizeContentFunction.role?.roleArn].filter(
              Boolean
            ),
          },
        ]),
