...
export class CompliAgentStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const documentTrackingTable = new dynamodb.Table(
      this,
    ...
    const textractCompletionTopic = new sns.Topic(
      this,
    ...
    masMonitorSchedule.addTarget(
      new targets.LambdaFunction(masMonitorFunction)
    );

    // Create Textract Processor Lambda function
    const textractProcessorFunction = new lambda.Function(
      this,
    ...
    const vectorizeContentFunction = new lambda.Function(
      this,
      "VectorizeContentFunction",
      {
      ...
      policy: JSON.stringify([
        {
          ...
          Principal: [vectorizeContentFunction.role?.roleArn].filter(Boolean),
        },
      ]),
    });
  ...
  private createAnalysisWorkflowFunctions(): void {
    ...
    const opensearchQueryFunction = new lambda.Function(
      this,
    ...
    const bedrockGapAnalysisFunction = new lambda.Function(
      this,
      "BedrockGapAnalysisFunction",
      {
    ...
    const queryVectorStore = new stepfunctionsTasks.LambdaInvoke(
      this,
      "QueryVectorStore",
      {
    ...
    const analyzeGaps = new stepfunctionsTasks.LambdaInvoke(
      this,
      "AnalyzeGaps",
      {
    ...
    const gapAnalysisDefinition = queryVectorStore
      .next(analyzeGaps)
      .next(storeGaps);

    // Create the Gap Analysis State Machine
    this.gapAnalysisWorkflow = new stepfunctions.StateMachine(
      this,
      "GapAnalysisWorkflow",
      {
  ...
  private createAPILayer(): void {
    ...
    const apiHandlerFunction = new lambda.Function(this, "ApiHandlerFunction", {
      ...
      environment: {
        ...
        GAP_ANALYSIS_STATE_MACHINE_ARN:
          this.gapAnalysisWorkflow.stateMachineArn,
      },
    ...
    const webSocketHandlerFunction = new lambda.Function(
      this,
